...
// During Vercel deployment, this will be set to the full Render URL (e.g., https://your-render-app.onrender.com/api).
// During local dev, it falls back to the proxy URL (localhost:5173/api) or a relative path.
